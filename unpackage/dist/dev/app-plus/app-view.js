...
var b7D=_mz(z,'trailer-stars',['bind:__l',30,'innerScore',1,'showNum',2,'vueId',3],[],e,s,gg)
_(e6D,b7D)
}
var o8D=_n('view')
...
_(aHE,tIE)
_(lGE,aHE)
var eJE=_mz(z,'scroll-view',['class',46,'scrollX',1],[],e,s,gg)
var bKE=_v()
_(eJE,bKE)
var oLE=function(oNE,xME,fOE,gg){
var hQE=_n('view')
_rz(z,hQE,'class',52,oNE,xME,gg)
var oRE=_mz(z,'image',['bindtap',53,'class',1,'data-event-opts',2,'data-staffIndex',3,'mode',4,'src',5],[],oNE,xME,gg)
_(hQE,oRE)
var cSE=_n('view')
_rz(z,cSE,'class',59,oNE,xME,gg)
var oTE=_oz(z,60,oNE,xME,gg)
_(cSE,oTE)
_(hQE,cSE)
var lUE=_n('view')
_rz(z,lUE,'class',61,oNE,xME,gg)
var aVE=_oz(z,62,oNE,xME,gg)
_(lUE,aVE)
_(hQE,lUE)
_(fOE,hQE)
return fOE
...
bKE.wxXCkey=2
_2z(z,50,oLE,e,s,gg,bKE,'director','staffIndex','staffId')
var tWE=_v()
_(eJE,tWE)
var eXE=function(oZE,bYE,x1E,gg){
var f3E=_n('view')
_rz(z,f3E,'class',67,oZE,bYE,gg)
var c4E=_mz(z,'image',['bindtap',68,'class',1,'data-event-opts',2,'data-staffIndex',3,'mode',4,'src',5],[],oZE,bYE,gg)
_(f3E,c4E)
var h5E=_n('view')
_rz(z,h5E,'class',74,oZE,bYE,gg)
var o6E=_oz(z,75,oZE,bYE,gg)
_(h5E,o6E)
_(f3E,h5E)
var c7E=_n('view')
_rz(z,c7E,'class',76,oZE,bYE,gg)
var o8E=_oz(z,77,oZE,bYE,gg)
_(c7E,o8E)
_(f3E,c7E)
_(x1E,f3E)
return x1E
...
tWE.wxXCkey=2
_2z(z,65,eXE,e,s,gg,tWE,'actor','actorIndex','staffId')
_(lGE,eJE)
_(xGD,lGE)
var l9E=_n('view')
_rz(z,l9E,'class',78,e,s,gg)
var a0E=_n('view')
_rz(z,a0E,'class',79,e,s,gg)
var tAF=_oz(z,80,e,s,gg)
_(a0E,tAF)
_(l9E,a0E)
var eBF=_mz(z,'scroll-view',['class',81,'scrollX',1],[],e,s,gg)
var bCF=_v()
_(eBF,bCF)
var oDF=function(oFF,xEF,fGF,gg){
var hIF=_mz(z,'image',['bindtap',87,'class',1,'data-event-opts',2,'mode',3,'src',4],[],oFF,xEF,gg)
_(fGF,hIF)
return fGF
}
bCF.wxXCkey=2
_2z(z,85,oDF,e,s,gg,bCF,'img','imgIndex','*this')
_(l9E,eBF)
_(xGD,l9E)
_(r,xGD)
return r
...
var oLF=_mz(z,'form',['bindsubmit',1,'data-event-opts',1],[],e,s,gg)
var lMF=_n('view')
...
_(ePF,bQF)
_(tOF,ePF)
var oRF=_mz(z,'input',['class',9,'name',1,'placeholder',2,'placeholderClass',3,'type',4,'value',5],[],e,s,gg)
_(tOF,oRF)
_(oLF,tOF)
var xSF=_mz(z,'view',['class',15,'style',1],[],e,s,gg)
var oTF=_n('label')
_rz(z,oTF,'class',17,e,s,gg)
var fUF=_oz(z,18,e,s,gg)
_(oTF,fUF)
_(xSF,oTF)
var cVF=_mz(z,'input',['class',19,'name',1,'password',2,'placeholder',3,'placeholderClass',4,'type',5,'value',6],[],e,s,gg)
_(xSF,cVF)
_(oLF,xSF)
var hWF=_mz(z,'button',['formType',26,'style',1,'type',2],[],e,s,gg)
...
_(a2F,t3F)
_(l1F,a2F)
var e4F=_mz(z,'input',['bindconfirm',5,'class',1,'confirmType',2,'data-event-opts',3,'maxlength',4,'placeholder',5,'type',6],[],e,s,gg)
_(l1F,e4F)
_(oZF,l1F)
var b5F=_n('view')
...
var oBG=_n('view')
_rz(z,oBG,'class',17,f9F,o8F,gg)
var cCG=_mz(z,'image',['bindtap',18,'class',1,'data-event-opts',2,'data-trailerId',3,'src',4],[],f9F,o8F,gg)
_(oBG,cCG)
_(c0F,oBG)
return c0F
}
o6F.wxXCkey=2
_2z(z,15,x7F,e,s,gg,o6F,'item','__i0__','id')
_(oZF,b5F)
_(r,oZF)
return r
}
