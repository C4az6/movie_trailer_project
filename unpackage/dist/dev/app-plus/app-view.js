...
var o2B=_mz(z,'video',['controls',-1,'class',45,'poster',1,'src',2],[],fYB,oXB,gg)
_(cZB,o2B)
return cZB
}
oVB.wxXCkey=2
...
_(oX,bUB)
var c3B=_n('view')
_rz(z,c3B,'class',48,e,s,gg)
var o4B=_n('view')
_rz(z,o4B,'class',49,e,s,gg)
var l5B=_mz(z,'image',['class',50,'src',1],[],e,s,gg)
_(o4B,l5B)
var a6B=_n('view')
...
var hEC=_n('view')
_rz(z,hEC,'class',59,oBC,xAC,gg)
var oFC=_mz(z,'image',['class',60,'src',1],[],oBC,xAC,gg)
_(hEC,oFC)
var cGC=_n('view')
_rz(z,cGC,'class',62,oBC,xAC,gg)
var oHC=_n('view')
_rz(z,oHC,'class',63,oBC,xAC,gg)
var lIC=_oz(z,64,oBC,xAC,gg)
_(oHC,lIC)
_(cGC,oHC)
var aJC=_mz(z,'trailer-stars',['bind:__l',65,'innerScore',1,'showNum',2,'vueId',3],[],oBC,xAC,gg)
_(cGC,aJC)
var tKC=_n('view')
_rz(z,tKC,'class',69,oBC,xAC,gg)
var eLC=_oz(z,70,oBC,xAC,gg)
_(tKC,eLC)
_(cGC,tKC)
var bMC=_n('view')
_rz(z,bMC,'class',71,oBC,xAC,gg)
var oNC=_oz(z,72,oBC,xAC,gg)
_(bMC,oNC)
_(cGC,bMC)
_(hEC,cGC)
var xOC=_mz(z,'view',['bindtap',73,'class',1,'data-event-opts',2,'data-gIndex',3],[],oBC,xAC,gg)
var oPC=_mz(z,'image',['class',77,'src',1],[],oBC,xAC,gg)
_(xOC,oPC)
var fQC=_n('view')
_rz(z,fQC,'class',79,oBC,xAC,gg)
var cRC=_oz(z,80,oBC,xAC,gg)
_(fQC,cRC)
_(xOC,fQC)
var hSC=_mz(z,'view',['animation',81,'class',1],[],oBC,xAC,gg)
var oTC=_oz(z,83,oBC,xAC,gg)
_(hSC,oTC)
_(xOC,hSC)
_(hEC,xOC)
_(fCC,hEC)
...
b9B.wxXCkey=4
_2z(z,57,o0B,e,s,gg,b9B,'item','guessIndex','id')
_(oX,e8B)
_(r,oX)
return r
}
...
var b1C=_mz(z,'video',['controls',-1,'class',2,'poster',1,'src',2],[],e,s,gg)
_(eZC,b1C)
_(tYC,eZC)
var o2C=_n('view')
_rz(z,o2C,'class',5,e,s,gg)
var x3C=_n('navigator')
_rz(z,x3C,'url',6,e,s,gg)
...
var oND=_mz(z,'trailer-stars',['bind:__l',28,'innerScore',1,'showNum',2,'vueId',3],[],e,s,gg)
_(cMD,oND)
}
var lOD=_n('view')
...
_(hYD,oZD)
_(cXD,hYD)
var c1D=_mz(z,'scroll-view',['class',44,'scrollX',1],[],e,s,gg)
var o2D=_v()
_(c1D,o2D)
var l3D=function(t5D,a4D,e6D,gg){
var o8D=_n('view')
_rz(z,o8D,'class',50,t5D,a4D,gg)
var x9D=_mz(z,'image',['bindtap',51,'class',1,'data-event-opts',2,'data-staffIndex',3,'mode',4,'src',5],[],t5D,a4D,gg)
_(o8D,x9D)
var o0D=_n('view')
_rz(z,o0D,'class',57,t5D,a4D,gg)
var fAE=_oz(z,58,t5D,a4D,gg)
_(o0D,fAE)
_(o8D,o0D)
var cBE=_n('view')
_rz(z,cBE,'class',59,t5D,a4D,gg)
var hCE=_oz(z,60,t5D,a4D,gg)
_(cBE,hCE)
_(o8D,cBE)
_(e6D,o8D)
return e6D
...
o2D.wxXCkey=2
_2z(z,48,l3D,e,s,gg,o2D,'director','staffIndex','staffId')
var oDE=_v()
_(c1D,oDE)
var cEE=function(lGE,oFE,aHE,gg){
var eJE=_n('view')
_rz(z,eJE,'class',65,lGE,oFE,gg)
var bKE=_mz(z,'image',['bindtap',66,'class',1,'data-event-opts',2,'data-staffIndex',3,'mode',4,'src',5],[],lGE,oFE,gg)
_(eJE,bKE)
var oLE=_n('view')
_rz(z,oLE,'class',72,lGE,oFE,gg)
var xME=_oz(z,73,lGE,oFE,gg)
_(oLE,xME)
_(eJE,oLE)
var oNE=_n('view')
_rz(z,oNE,'class',74,lGE,oFE,gg)
var fOE=_oz(z,75,lGE,oFE,gg)
_(oNE,fOE)
_(eJE,oNE)
_(aHE,eJE)
return aHE
...
oDE.wxXCkey=2
_2z(z,63,cEE,e,s,gg,oDE,'actor','actorIndex','staffId')
_(cXD,c1D)
_(tYC,cXD)
var cPE=_n('view')
_rz(z,cPE,'class',76,e,s,gg)
var hQE=_n('view')
_rz(z,hQE,'class',77,e,s,gg)
var oRE=_oz(z,78,e,s,gg)
_(hQE,oRE)
_(cPE,hQE)
var cSE=_mz(z,'scroll-view',['class',79,'scrollX',1],[],e,s,gg)
var oTE=_v()
_(cSE,oTE)
var lUE=function(tWE,aVE,eXE,gg){
var oZE=_mz(z,'image',['bindtap',85,'class',1,'data-event-opts',2,'mode',3,'src',4],[],tWE,aVE,gg)
_(eXE,oZE)
return eXE
}
oTE.wxXCkey=2
_2z(z,83,lUE,e,s,gg,oTE,'img','imgIndex','*this')
_(cPE,cSE)
_(tYC,cPE)
_(r,tYC)
return r
