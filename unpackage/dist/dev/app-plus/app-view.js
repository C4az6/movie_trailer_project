...
Z([3,'movie-wapper'])
Z([3,'poster'])
Z([3,'http://122.152.205.72:88/superhero/DC/BatManTheDarkKnightRises/cover.jpg'])
Z(z[10])
Z(z[11])
Z(z[12])
Z(z[10])
...
var x=['./components/trailerStars.wxml','./pages/index/index.wxml','./pages/me/me.wxml','./pages/search/search.wxml'];d_[x[0]]={}
...
var o4=_mz(z,'image',['class',8,'src',1],[],aZ,lY,gg)
_(b3,o4)
_(t1,b3)
return t1
}
cW.wxXCkey=2
_2z(z,6,oX,e,s,gg,cW,'item','__i0__','id')
_(hU,oV)
var x5=_n('view')
_rz(z,x5,'class',10,e,s,gg)
var o6=_n('view')
_rz(z,o6,'class',11,e,s,gg)
var f7=_mz(z,'image',['class',12,'src',1],[],e,s,gg)
_(o6,f7)
var c8=_n('view')
...
_(x5,o6)
_(hU,x5)
var o0=_mz(z,'scroll-view',['class',16,'scrollX',1],[],e,s,gg)
var cAB=_v()
_(o0,cAB)
var oBB=function(aDB,lCB,tEB,gg){
var bGB=_n('view')
_rz(z,bGB,'class',22,aDB,lCB,gg)
var oHB=_n('view')
_rz(z,oHB,'class',23,aDB,lCB,gg)
var xIB=_mz(z,'image',['class',24,'src',1],[],aDB,lCB,gg)
_(oHB,xIB)
_(bGB,oHB)
var oJB=_n('view')
_rz(z,oJB,'class',26,aDB,lCB,gg)
var fKB=_oz(z,27,aDB,lCB,gg)
_(oJB,fKB)
_(bGB,oJB)
var cLB=_mz(z,'trailer-stars',['bind:__l',28,'innerScore',1,'showNum',2,'vueId',3],[],aDB,lCB,gg)
_(bGB,cLB)
_(tEB,bGB)
return tEB
}
cAB.wxXCkey=4
_2z(z,20,oBB,e,s,gg,cAB,'item','__i1__','id')
_(hU,o0)
var hMB=_n('view')
_rz(z,hMB,'class',32,e,s,gg)
var oNB=_n('view')
_rz(z,oNB,'class',33,e,s,gg)
var cOB=_mz(z,'image',['class',34,'src',1],[],e,s,gg)
_(oNB,cOB)
var oPB=_n('view')
...
var fYB=_mz(z,'video',['controls',-1,'class',43,'poster',1,'src',2],[],oVB,bUB,gg)
_(xWB,fYB)
return xWB
}
tSB.wxXCkey=2
_2z(z,41,eTB,e,s,gg,tSB,'item','__i2__','id')
_(hU,aRB)
var cZB=_n('view')
_rz(z,cZB,'class',46,e,s,gg)
var h1B=_n('view')
_rz(z,h1B,'class',47,e,s,gg)
var o2B=_mz(z,'image',['class',48,'src',1],[],e,s,gg)
_(h1B,o2B)
var c3B=_n('view')
_rz(z,c3B,'class',50,e,s,gg)
var o4B=_oz(z,51,e,s,gg)
_(c3B,o4B)
_(h1B,c3B)
_(cZB,h1B)
_(hU,cZB)
var l5B=_n('view')
_rz(z,l5B,'class',52,e,s,gg)
var a6B=_v()
_(l5B,a6B)
var t7B=function(b9B,e8B,o0B,gg){
var oBC=_n('view')
_rz(z,oBC,'class',57,b9B,e8B,gg)
var fCC=_mz(z,'image',['class',58,'src',1],[],b9B,e8B,gg)
_(oBC,fCC)
var cDC=_n('view')
_rz(z,cDC,'class',60,b9B,e8B,gg)
var hEC=_n('view')
_rz(z,hEC,'class',61,b9B,e8B,gg)
var oFC=_oz(z,62,b9B,e8B,gg)
_(hEC,oFC)
_(cDC,hEC)
var cGC=_mz(z,'trailer-stars',['bind:__l',63,'innerScore',1,'showNum',2,'vueId',3],[],b9B,e8B,gg)
_(cDC,cGC)
var oHC=_n('view')
_rz(z,oHC,'class',67,b9B,e8B,gg)
var lIC=_oz(z,68,b9B,e8B,gg)
_(oHC,lIC)
_(cDC,oHC)
var aJC=_n('view')
_rz(z,aJC,'class',69,b9B,e8B,gg)
var tKC=_oz(z,70,b9B,e8B,gg)
_(aJC,tKC)
_(cDC,aJC)
_(oBC,cDC)
var eLC=_mz(z,'view',['bindtap',71,'class',1,'data-event-opts',2,'data-gIndex',3],[],b9B,e8B,gg)
var bMC=_mz(z,'image',['class',75,'src',1],[],b9B,e8B,gg)
_(eLC,bMC)
var oNC=_n('view')
_rz(z,oNC,'class',77,b9B,e8B,gg)
var xOC=_oz(z,78,b9B,e8B,gg)
_(oNC,xOC)
_(eLC,oNC)
var oPC=_mz(z,'view',['animation',79,'class',1],[],b9B,e8B,gg)
var fQC=_oz(z,81,b9B,e8B,gg)
_(oPC,fQC)
_(eLC,oPC)
_(oBC,eLC)
_(o0B,oBC)
...
a6B.wxXCkey=4
_2z(z,55,t7B,e,s,gg,a6B,'item','guessIndex','id')
_(hU,l5B)
_(r,hU)
return r
}
...
var tYC=_mz(z,'image',['class',3,'src',1],[],e,s,gg)
_(aXC,tYC)
_(lWC,aXC)
var eZC=_mz(z,'input',['focus',-1,'class',5,'maxlength',1,'placeholder',2,'type',3],[],e,s,gg)
_(lWC,eZC)
_(oVC,lWC)
var b1C=_n('view')
...
var x3C=_mz(z,'image',['class',11,'src',1],[],e,s,gg)
_(o2C,x3C)
_(b1C,o2C)
var o4C=_n('view')
_rz(z,o4C,'class',13,e,s,gg)
var f5C=_mz(z,'image',['class',14,'src',1],[],e,s,gg)
_(o4C,f5C)
_(b1C,o4C)
var c6C=_n('view')
_rz(z,c6C,'class',16,e,s,gg)
var h7C=_mz(z,'image',['class',17,'src',1],[],e,s,gg)
_(c6C,h7C)
_(b1C,c6C)
var o8C=_n('view')
...
var lAD=_mz(z,'image',['class',23,'src',1],[],e,s,gg)
_(o0C,lAD)
_(b1C,o0C)
var aBD=_n('view')
_rz(z,aBD,'class',25,e,s,gg)
var tCD=_mz(z,'image',['class',26,'src',1],[],e,s,gg)
_(aBD,tCD)
_(b1C,aBD)
var eDD=_n('view')
_rz(z,eDD,'class',28,e,s,gg)
var bED=_mz(z,'image',['class',29,'src',1],[],e,s,gg)
_(eDD,bED)
_(b1C,eDD)
var oFD=_n('view')
_rz(z,oFD,'class',31,e,s,gg)
var xGD=_mz(z,'image',['class',32,'src',1],[],e,s,gg)
_(oFD,xGD)
_(b1C,oFD)
var oHD=_n('view')
_rz(z,oHD,'class',34,e,s,gg)
var fID=_mz(z,'image',['class',35,'src',1],[],e,s,gg)
_(oHD,fID)
_(b1C,oHD)
var cJD=_n('view')
_rz(z,cJD,'class',37,e,s,gg)
var hKD=_mz(z,'image',['class',38,'src',1],[],e,s,gg)
_(cJD,hKD)
_(b1C,cJD)
var oLD=_n('view')
_rz(z,oLD,'class',40,e,s,gg)
var cMD=_mz(z,'image',['class',41,'src',1],[],e,s,gg)
_(oLD,cMD)
_(b1C,oLD)
var oND=_n('view')
_rz(z,oND,'class',43,e,s,gg)
var lOD=_mz(z,'image',['class',44,'src',1],[],e,s,gg)
_(oND,lOD)
_(b1C,oND)
var aPD=_n('view')
_rz(z,aPD,'class',46,e,s,gg)
var tQD=_mz(z,'image',['class',47,'src',1],[],e,s,gg)
_(aPD,tQD)
_(b1C,aPD)
_(oVC,b1C)
_(r,oVC)
