<template name="trailerStars">
	<view class="movie-score-wapper">
		<image v-for="yello in yelloScore" src="/static/icos/star-yellow.png" class="start-icon">
		</image>

		<image v-for="gray in grayScore" src="/static/icos/star-gray.png" class="start-icon"></image>
...
<script>
	export default {
		...
		created() {
			...
			let yelloScore = parseInt(tempScore / 2);
			let grayScore = 5 - yelloScore;
